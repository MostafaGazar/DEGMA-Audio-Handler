 ...
 */
public class ConvertTrackPanel extends JPanel {
	private static final long serialVersionUID = 666L;
	private ConvertAlbumPanel aAlbumPanel = null;
	private JTable aTrackTable = null;

	public ConvertTrackPanel() {
		super();
		aTrackTable = new JTable(new AlbumModel());
		JScrollPane scrollPane = new JScrollPane();

		aAlbumPanel = new ConvertAlbumPanel();
	 ...
	 */
	public ConvertAlbumPanel getAlbumPanel() {
		return aAlbumPanel;
	}
