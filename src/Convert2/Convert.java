...
import Convert2.MainWindow;
import RipConvertShared.thread.ThreadCollector;
...
public class Convert extends Application {
	...
	private static Convert aaRipper;
	...
	public static void main(String[] args) {
		...
		SwingUtilities.invokeLater(new Runnable() {
			public void run() {
				...
				/*
				 * Pref.setPref("w", 500); Pref.setPref("h", 400);
				 * Pref.setPref("x", 100); Pref.setPref("y", 100);
				 */
