package controller.JAVAconvert.MP3_To_WAV;
...
public class MP3_To_WAV {
	...
	// try {
	//				new MP3_To_WAV(runningAudio, Messages.getString("Constants.temp_cut")); //$NON-NLS-1$
	// } catch (Exception e) {
	//				JOptionPane.showMessageDialog(NewMain.frame, Messages.getString("Constants.error")+e.getMessage(), Messages.getString("Constants.title_SorryButProcessCanNotCompleted"),  //$NON-NLS-1$
	...
	// random instead of 1
	// }
	//		String arg[]={"-o", Messages.getString("Constants.file")+dest, Messages.getString("Constants.file")+runningAudio};//, "-s", "5000", "-e", "10000","-s", "50000", "-e", "100000"}; //$NON-NLS-1$
	...
	//
	// for(int i=0;i<len;i++){
	//			System.out.print(toSend[i]+"  "); //$NON-NLS-1$
	// }
	//
