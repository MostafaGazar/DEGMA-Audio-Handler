package controller.cutJustWavToWavOrMp3;
 ...
 */
public class CopyOfCutWithNoUI implements ControllerListener, DataSinkListener {
	...
	public static void cut(String[] args) {// , WaitingDialog holdingWd1){
		...
		CopyOfCutWithNoUI cut = new CopyOfCutWithNoUI();
