 ...
 */
package view.sideBar.plaf.misc;
...
import view.sideBar.plaf.basic.BasicButtonBarUI;

/**
 * An implementation for the JButtonBar UI which looks like the one found in <a
 * href="http://www.stardock.com/products/iconpackager/">IconPackager 2.5 </a>.
 */
public class IconPackagerButtonBarUI extends BasicButtonBarUI {
	...
	protected void installDefaults() {
		...
		if (b == null || b instanceof UIResource) {
			bar.setBorder(new BorderUIResource(new CompoundBorder(BorderFactory
					.createEtchedBorder(), BorderFactory.createEmptyBorder(2,
					2, 2, 2))));
		}
	...
	static class ButtonUI extends BasicButtonUI implements ButtonBarButtonUI {
		...
		public void paint(Graphics g, JComponent c) {
			...
			// this is a tweak to get the View with the color we expect it to
			// be. We
