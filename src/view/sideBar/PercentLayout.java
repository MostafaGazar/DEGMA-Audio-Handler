...
public class PercentLayout implements LayoutManager2 {
	...
	private Hashtable<Component, Object> m_ComponentToConstraint;
	...
	public PercentLayout(int orientation, int gap) {
		...
		m_ComponentToConstraint = new Hashtable<Component, Object>();
	}
		...
		if (constraints instanceof Constraint) {
			...
			if (s.endsWith("%")) {
				...
				setConstraint(component,
						new NumberConstraint(Integer.valueOf(s)));
			}
